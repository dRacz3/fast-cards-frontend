...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    SOCKET_ONOPEN(state, event) {
      ...
      sendToListeners(
        new SocketEvent(SocketEventTypes.SOCKET_ONOPEN, event),
    ...
    SOCKET_ONERROR(state, event) {
      ...
      sendToListeners(
        new SocketEvent(SocketEventTypes.SOCKET_ONERROR, event),
        state.socket_event_listeners
      );
    },
    ...
    SOCKET_RECONNECT(state, count) {
      ...
      sendToListeners(
        new SocketEvent(SocketEventTypes.SOCKET_RECONNECT, count),
        state.socket_event_listeners
      );
    },
