...
------------- | ------------- | -------------
[**apiBlackCardsList**](ApiApi.md#apiBlackCardsList) | **GET** /api/black_cards/ | 
[**apiBlackCardsPartialUpdate**](ApiApi.md#apiBlackCardsPartialUpdate) | **PATCH** /api/black_cards/{card_id}/ | 
[**apiBlackCardsRead**](ApiApi.md#apiBlackCardsRead) | **GET** /api/black_cards/{card_id}/ | 
[**apiBlackCardsUpdate**](ApiApi.md#apiBlackCardsUpdate) | **PUT** /api/black_cards/{card_id}/ | 
...
[**apiWhiteCardsList**](ApiApi.md#apiWhiteCardsList) | **GET** /api/white_cards/ | 
[**apiWhiteCardsPartialUpdate**](ApiApi.md#apiWhiteCardsPartialUpdate) | **PATCH** /api/white_cards/{card_id}/ | 
[**apiWhiteCardsRead**](ApiApi.md#apiWhiteCardsRead) | **GET** /api/white_cards/{card_id}/ | 
[**apiWhiteCardsUpdate**](ApiApi.md#apiWhiteCardsUpdate) | **PUT** /api/white_cards/{card_id}/ | 



## apiBlackCardsList

> InlineResponse200 apiBlackCardsList(opts)
...
apiInstance.apiBlackCardsList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
## apiBlackCardsPartialUpdate

> BlackCard apiBlackCardsPartialUpdate(cardId, data)
...
apiInstance.apiBlackCardsPartialUpdate(cardId, data, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BlackCard apiBlackCardsRead(cardId)
...
let apiInstance = new CardsAgainstHumanityDjangoApi.ApiApi();
let cardId = 56; // Number | A unique integer value identifying this black card.
apiInstance.apiBlackCardsRead(cardId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BlackCard apiBlackCardsUpdate(cardId, data)
...
let cardId = 56; // Number | A unique integer value identifying this black card.
let data = new CardsAgainstHumanityDjangoApi.BlackCard(); // BlackCard | 
apiInstance.apiBlackCardsUpdate(cardId, data, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> InlineResponse2001 apiWhiteCardsList(opts)
...
apiInstance.apiWhiteCardsList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## apiWhiteCardsPartialUpdate

> WhiteCard apiWhiteCardsPartialUpdate(cardId, data)
...
apiInstance.apiWhiteCardsPartialUpdate(cardId, data, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> WhiteCard apiWhiteCardsRead(cardId)
...
let apiInstance = new CardsAgainstHumanityDjangoApi.ApiApi();
let cardId = 56; // Number | A unique integer value identifying this white card.
apiInstance.apiWhiteCardsRead(cardId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> WhiteCard apiWhiteCardsUpdate(cardId, data)
...
let cardId = 56; // Number | A unique integer value identifying this white card.
let data = new CardsAgainstHumanityDjangoApi.WhiteCard(); // WhiteCard | 
apiInstance.apiWhiteCardsUpdate(cardId, data, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
