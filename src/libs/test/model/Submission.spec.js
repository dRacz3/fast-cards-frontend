...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastCards.Submission();
  });
  ...
  describe('Submission', function() {
    it('should create an instance of Submission', function() {
      ...
      //var instane = new FastCards.Submission();
      //expect(instance).to.be.a(FastCards.Submission);
    });

    it('should have the property blackCard (base name: "black_card")', function() {
      // uncomment below and update the code to test the property blackCard
      //var instane = new FastCards.Submission();
