...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastCards.PlayerOutsideView();
  });
  ...
  describe('PlayerOutsideView', function() {
    it('should create an instance of PlayerOutsideView', function() {
      // uncomment below and update the code to test PlayerOutsideView
      //var instane = new FastCards.PlayerOutsideView();
      //expect(instance).to.be.a(FastCards.PlayerOutsideView);
    });
