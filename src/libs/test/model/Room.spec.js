...
(function(root, factory) {
  ...
  describe('Room', function() {
    it('should create an instance of Room', function() {
      ...
      //var instane = new FastCards.Room();
      //expect(instance).to.be.a(FastCards.Room);
    });
    ...
    it('should have the property playerCount (base name: "player_count")', function() {
